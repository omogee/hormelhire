...
function Navbar() {
    ...
    {url:"why hormel",name:"why hormel"}, {url:"about",name:"About us"},{url:"meet Our Team",name:"Meet Our team"},{url:"hire",name:"Hire labour"},
    {url:"login",name:"login/register"}])
    ...
    return ( 
        <div style={{position:"sticky",top:"0px",left:"0px",width:"100%",zIndex:"1000"}}>
            <nav >
